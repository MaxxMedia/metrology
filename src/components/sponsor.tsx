...
const SponsorsSection = () => {
    ...
    return (
        <section className="bg-[#f5f5f5] pt-[60px] pb-[80px] max-sm:pt-10 max-sm:pb-[50px]">
            <Container>
                <h2 className="font-display text-[2.8rem] leading-[1.2] font-bold uppercase text-left text-[#07847E111] mb-[50px] max-md:text-[2.2rem] max-md:mb-[35px] max-sm:text-[1.8rem] max-sm:mb-[25px]">SPONSORS</h2>
                ...
                >
                    <h3 className="font-display text-[1.4rem] font-semibold uppercase text-left text-[#07847E111] mb-[30px] max-md:text-[1.2rem] max-md:mb-5 max-sm:text-[1rem] max-sm:mb-[15px]"></h3>
