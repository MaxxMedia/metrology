...
export default function PageBanner({ title, subtitle, ctaText, ctaHref }: Props) {
  ...
  return (
    <section className="bg-[linear-gradient(135deg,#003366_0%,#144380_100%)] w-full h-auto relative overflow-hidden min-h-[250px] flex items-center max-md:py-10 max-md:min-h-[140px] max-sm:py-[30px] max-sm:min-h-[120px]">
