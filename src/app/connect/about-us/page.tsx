      ...
      <section className="py-16 max-sm:py-10">
        <div className="w-full max-w-[1440px] mx-auto px-10 max-lg:px-6 max-sm:px-4">
          ...
          <div className="flex flex-col items-center justify-center gap-6 mb-12">
            ...
            <h2 className="font-display text-[32px] max-md:text-[26px] font-bold text-center uppercase text-[#07847E] leading-tight mt-6 max-w-[800px]">
          ...
          <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-0 mb-10 overflow-hidden border border-[#dee2e6] bg-[#f4f5f7]">
            <div className="p-12 max-md:p-8 max-sm:p-6 flex flex-col justify-center">
              <p className="font-body text-[16px] max-sm:text-sm leading-relaxed font-bold text-[#07847E] mb-5">
          ...
          <div className="mb-16 text-center">
            <h2 className="font-display text-[32px] max-sm:text-[26px] font-bold uppercase text-[#07847E] mb-8">
              PROUD MEMBER
            </h2>
