                            ...
                            >
                                ...
                                <div className="p-6 max-sm:p-5 flex flex-col flex-1 items-start gap-4">
                                    <div className="flex flex-col gap-[3px] w-full">
                                        ...
                                        <h3 className="font-display text-[22px] max-sm:text-[20px] font-bold text-[#144380] uppercase m-0 leading-[1.2] mt-1">
                                            {item.name}
                                        </h3>
                                    ...
                                    <div className="flex flex-col gap-1 w-full text-[13px] text-[#444] font-body">
                                        <span className="truncate">
                                            <strong className="text-[#144380]">E:</strong> {item.email}
                                        </span>
                                        <span>
                                            <strong className="text-[#144380]">T:</strong> {item.phone}
                                        </span>
                                    </div>
