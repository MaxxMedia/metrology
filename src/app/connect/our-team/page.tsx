                ...
                <div className="w-full max-w-[1440px] mx-auto px-10 max-lg:px-6 max-sm:px-4 flex flex-col gap-16 max-sm:gap-10">
                    {teamSections.map((section, index) => (
                        <div key={index} className="flex flex-col gap-6">
                            {/* Section Title */}
                            <h2 className="font-display text-[32px] max-sm:text-[26px] font-bold text-[#144380] uppercase tracking-wide m-0 border-b border-[#dee2e6] pb-3">
                                {section.title}
                            </h2>
                                    ...
                                    >
                                        ...
                                        <div className="p-6 max-sm:p-5 flex flex-col flex-1 items-start gap-4">
                                            <div className="flex flex-col gap-[3px] w-full">
                                                <h3 className="font-display text-[22px] max-sm:text-[20px] font-bold text-[#144380] uppercase m-0 leading-[1.2]">
                                                    {member.name}
                                                </h3>
                                            ...
                                            <div className="flex flex-col gap-1 w-full text-[13px] text-[#444] font-body">
                                                <span className="truncate">
                                                    <strong className="text-[#144380]">E:</strong> {member.email}
                                                </span>
                                                <span>
                                                    <strong className="text-[#144380]">T:</strong> {member.phone}
                                                </span>
                                            </div>
