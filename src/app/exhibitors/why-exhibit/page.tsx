                ...
                <div className="w-full max-w-[1440px] mx-auto px-6">
                    ...
                    <form className="w-full" onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex flex-col gap-3">
                                {["Metrology Equipment Manufacturer", "Quality & Inspection Solutions Provider", "Calibration & Testing Services" ,"Machine Vision & Automation","Software / Industry 4.0 Solutions","Other"].map((item) => (
                                    <label key={item} className="flex items-center gap-3 text-[#144380] text-sm cursor-pointer">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex flex-col gap-3">
                                {events.map((event) => (
                                    <label key={event} className="flex items-center gap-3 text-[#144380] text-sm cursor-pointer">
