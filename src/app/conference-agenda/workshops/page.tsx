        ...
        <main className="w-full overflow-hidden bg-white">
                ...
                <div className="w-full max-w-[1440px] mx-auto px-10 max-lg:px-6 max-sm:px-4">
                    ...
                    <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-[60px] max-lg:gap-10 items-center">
                        ...
                        <div className="flex flex-col gap-8 max-sm:gap-6">
                            <h2 className="font-display text-[40px] max-md:text-[32px] leading-tight text-[#144380] mb-2 uppercase font-bold">
                                Join Us For Our Workshops!
                            </h2>

                            <div className="flex flex-col gap-2">
                                <h3 className="text-[17px] text-[#144380] font-bold m-0 font-body">
            ...
            <section className="py-12 pb-20">
                <div className="w-full max-w-[1440px] mx-auto px-10 max-lg:px-6 max-sm:px-4">
                    ...
                    <div className="mb-12">
                        <span className="font-display text-[22px] font-bold text-[#144380] block tracking-wide">
                            THE TOPICS FOR
                        </span>
                        <h2 className="font-display text-[34px] max-sm:text-[28px] leading-tight text-[#144380] font-bold uppercase m-0 mt-1">
