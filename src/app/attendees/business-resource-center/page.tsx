                ...
                <div className="max-w-[1280px] mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 max-lg:grid-cols-1 gap-[50px] max-lg:gap-[30px] items-start mb-[70px]">
                        ...
                        <div className="flex flex-col gap-[20px]">
                            <p className="text-[0.88rem] max-md:text-[0.85rem] max-sm:text-[0.8rem] leading-[1.6] max-md:leading-[1.5] text-[#07847E] font-normal">
                    ...
                    <h2 className="font-display text-[2rem] max-lg:text-[2.2rem] max-md:text-[1.8rem] max-sm:text-[1.3rem] leading-none uppercase text-[#07847E] mb-[40px] max-md:mb-[30px] max-sm:mb-[25px]">
            ...
            <section className="py-[60px] pb-[80px]">
                <div className="max-w-[1280px] mx-auto px-6">
                    <div className="bg-white py-[42px] px-[48px] max-sm:py-[30px] max-sm:px-[22px] rounded-[2px] shadow-[0_2px_14px_rgba(0,0,0,0.04)]">
                        ...
                        <h2 className="font-display text-[2.4rem] max-sm:text-[1.8rem] leading-none uppercase text-[#07847E827] mb-[22px]">GET IN TOUCH</h2>
                        ...
                        <div className="mt-4">
                            <h3 className="font-display font-semibold text-lg text-[#07847E827] uppercase">Padmanabham R</h3>
