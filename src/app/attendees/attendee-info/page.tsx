          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            {attendeeCards.map((card, index) => (
              ...
              >
                ...
                <div className={`absolute left-0 bottom-0 w-full h-full bg-[#FE6B0B] px-6 pb-6 max-lg:px-5 max-lg:pb-5 max-md:px-4 max-md:pb-4 z-10 flex flex-col items-center justify-start transition-transform duration-[550ms] ease-out before:content-[''] before:absolute before:-top-2.5 before:left-1/2 before:-translate-x-1/2 before:border-x-8 before:border-x-transparent before:border-b-[10px] before:border-b-[#003366] ${flipped[index] ? 'translate-y-0' : 'translate-y-[calc(100%-80px)] max-lg:translate-y-[calc(100%-72px)] max-md:translate-y-[calc(100%-66px)] max-sm:translate-y-[calc(100%-58px)] group-hover:translate-y-0'}`}>
