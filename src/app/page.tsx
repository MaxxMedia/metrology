  ...
  <Container className="grid grid-cols-3 max-lg:grid-cols-1 items-center gap-10 max-sm:gap-6">
    ...
    <div className="flex items-center justify-center max-lg:justify-start gap-6">
      ...
      <div className="flex items-center gap-4">
        <h3 className="font-display text-[72px] max-sm:text-[52px] max-[375px]:text-[44px] leading-none font-bold text-[#07847E] whitespace-nowrap">
          150+
        </h3>
      ...
      <section className="bg-[#f5f5f5] py-[70px] max-xl:py-[60px] max-lg:py-[50px] max-sm:py-10">
        <Container className="grid grid-cols-[52%_48%] max-lg:grid-cols-1 gap-12 max-lg:gap-9 items-center">
          ...
          <div className="w-full">
            <h2 className="font-display text-[clamp(36px,4vw,60px)] max-lg:text-[44px] max-sm:text-[34px] leading-[0.95] font-bold uppercase text-[#07847E111] m-0 mb-7 -tracking-[1px]">
      ...
      {cards.map((card) => ( 
        <div key={card.title} className="bg-white overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-transform duration-250 ease-out flex flex-col h-full hover:-translate-y-2 group"> 
          ...
          <div className="p-9 max-lg:p-[24px_22px_22px] flex flex-col flex-1"> 
            <h3 className="font-display text-[28px] max-lg:text-[22px] leading-tight uppercase text-[#07847E111] mb-5 -tracking-[0.5px]">{card.title}</h3> 
            
            <p className="font-body text-[15px] max-lg:text-[12px] leading-relaxed text-[#07847E111] mb-8 font-medium flex-1">{card.description}</p> 
            
            <Link href={card.href} className="inline-flex items-center justify-between h-[56px] pl-6 pr-1.5 rounded-full bg-[#07847E] text-white no-underline font-display text-[20px] uppercase tracking-wider self-start gap-6 transition-all duration-300 ease-in-out min-w-[240px]" > 
      ...
      <section className="bg-white py-[60px] pb-[80px] max-lg:py-10 max-lg:pb-[50px] max-sm:py-[30px] max-sm:pb-10">
        <Container>
          ...
          <div className="flex items-center justify-between mb-10 max-lg:flex-col max-lg:items-start max-lg:gap-[18px] max-lg:mb-[28px]">
            <h2 className="font-display text-[clamp(2rem,3vw,3rem)] max-lg:text-[2.2rem] max-sm:text-[1.8rem] leading-none font-bold uppercase text-[#07847E111] m-0">NEWS &amp; BLOG</h2>
            <Link href="/resources/blog" className="group relative inline-flex items-center bg-[#07847E] text-white no-underline font-display text-[0.95rem] max-sm:text-[0.85rem] font-medium uppercase tracking-wider transition-colors duration-200 shrink-0 rounded-[999px] h-[50px] pl-[26px] pr-[62px] max-sm:h-[44px] max-sm:pl-5 max-sm:pr-[54px] hover:bg-[#004f99]">
              ALL NEWS
            ...
            {newsItems.map((item) => (
              ...
              >
                ...
                <div className="p-[18px] px-[22px] pb-[22px] max-sm:py-3.5 max-sm:px-4 max-sm:pb-[18px] flex-1">
                  <p className="font-display text-[0.85rem] max-sm:text-[0.75rem] uppercase text-[#07847E] mb-2.5">{item.date}</p>
                  <h3 className="font-display text-[1.4rem] max-sm:text-[1.15rem] leading-[1.2] font-bold uppercase text-[#07847E111] m-0">{item.title}</h3>
                </div>
                <div className="h-10 max-sm:h-9 bg-[#07847E] flex items-center justify-center font-display text-[0.85rem] max-sm:text-[0.75rem] font-medium uppercase text-white tracking-widest transition-colors duration-200 shrink-0 group-hover:bg-[#004f99]">READ MORE</div>
              </Link>
            ))}
          </div>
